...
abstract class Album implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Chinook\\Models\\Map\\AlbumTableMap';
    ...
    /**
     * Initializes internal state of Chinook\Models\Base\Album object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AlbumTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AlbumTableMap::translateFieldName('ArtistId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Chinook\\Models\\Album'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->album_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('album_album_id_seq')");
                $this->album_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Chinook\Models\Album (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Chinook\Models\Album Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
