 ...
 *
 * @method     ChildGenreQuery orderByGenreId($order = Criteria::ASC) Order by the genre_id column
 * @method     ChildGenreQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildGenreQuery groupByGenreId() Group by the genre_id column
 * @method     ChildGenreQuery groupByName() Group by the name column
 *
 ...
 *
 * @method     ChildGenreQuery leftJoinTrack($relationAlias = null) Adds a LEFT JOIN clause to the query using the Track relation
 * @method     ChildGenreQuery rightJoinTrack($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Track relation
 * @method     ChildGenreQuery innerJoinTrack($relationAlias = null) Adds a INNER JOIN clause to the query using the Track relation
 *
 * @method     ChildGenreQuery joinWithTrack($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Track relation
 *
 * @method     ChildGenreQuery leftJoinWithTrack() Adds a LEFT JOIN clause and with to the query using the Track relation
 * @method     ChildGenreQuery rightJoinWithTrack() Adds a RIGHT JOIN clause and with to the query using the Track relation
 * @method     ChildGenreQuery innerJoinWithTrack() Adds a INNER JOIN clause and with to the query using the Track relation
 *
 ...
 *
 * @method     ChildGenre|null findOneByGenreId(int $genre_id) Return the first ChildGenre filtered by the genre_id column
 * @method     ChildGenre|null findOneByName(string $name) Return the first ChildGenre filtered by the name column
 *
 ...
 *
 * @method     ChildGenre requireOneByGenreId(int $genre_id) Return the first ChildGenre filtered by the genre_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildGenre requireOneByName(string $name) Return the first ChildGenre filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildGenre[]|Collection find(?ConnectionInterface $con = null) Return ChildGenre objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildGenre> find(?ConnectionInterface $con = null) Return ChildGenre objects based on current ModelCriteria
 *
 * @method     ChildGenre[]|Collection findByGenreId(int|array<int> $genre_id) Return ChildGenre objects filtered by the genre_id column
 * @psalm-method Collection&\Traversable<ChildGenre> findByGenreId(int|array<int> $genre_id) Return ChildGenre objects filtered by the genre_id column
 * @method     ChildGenre[]|Collection findByName(string|array<string> $name) Return ChildGenre objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildGenre> findByName(string|array<string> $name) Return ChildGenre objects filtered by the name column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildGenre> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class GenreQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Chinook\Models\Base\GenreQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Chinook\\Models\\Genre', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT genre_id, name FROM genre WHERE genre_id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $keys, Criteria::IN);
    ...
    public function filterByGenreId($genreId = null, ?string $comparison = null)
    {
        if (is_array($genreId)) {
            ...
            if (isset($genreId['min'])) {
                $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $genreId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($genreId['max'])) {
                $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $genreId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $genreId, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(GenreTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByTrack($track, ?string $comparison = null)
    {
        if ($track instanceof \Chinook\Models\Track) {
            $this
                ->addUsingAlias(GenreTableMap::COL_GENRE_ID, $track->getGenreId(), $comparison);
    ...
    {
        if ($genre) {
            $this->addUsingAlias(GenreTableMap::COL_GENRE_ID, $genre->getGenreId(), Criteria::NOT_EQUAL);
        }
