...
use Chinook\Models\Map\MediaTypeTableMap;
 ...
 *
 * @method     ChildMediaTypeQuery orderByMediaTypeId($order = Criteria::ASC) Order by the media_type_id column
 * @method     ChildMediaTypeQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildMediaTypeQuery groupByMediaTypeId() Group by the media_type_id column
 ...
 *
 * @method     ChildMediaTypeQuery leftJoinTrack($relationAlias = null) Adds a LEFT JOIN clause to the query using the Track relation
 * @method     ChildMediaTypeQuery rightJoinTrack($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Track relation
 * @method     ChildMediaTypeQuery innerJoinTrack($relationAlias = null) Adds a INNER JOIN clause to the query using the Track relation
 *
 * @method     ChildMediaTypeQuery joinWithTrack($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Track relation
 *
 * @method     ChildMediaTypeQuery leftJoinWithTrack() Adds a LEFT JOIN clause and with to the query using the Track relation
 * @method     ChildMediaTypeQuery rightJoinWithTrack() Adds a RIGHT JOIN clause and with to the query using the Track relation
 * @method     ChildMediaTypeQuery innerJoinWithTrack() Adds a INNER JOIN clause and with to the query using the Track relation
 *
 * @method     \Chinook\Models\TrackQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildMediaType|null findOne(?ConnectionInterface $con = null) Return the first ChildMediaType matching the query
 ...
 *
 * @method     ChildMediaType|null findOneByMediaTypeId(int $media_type_id) Return the first ChildMediaType filtered by the media_type_id column
 * @method     ChildMediaType|null findOneByName(string $name) Return the first ChildMediaType filtered by the name column
 *
 ...
 *
 * @method     ChildMediaType requireOneByMediaTypeId(int $media_type_id) Return the first ChildMediaType filtered by the media_type_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildMediaType[]|Collection find(?ConnectionInterface $con = null) Return ChildMediaType objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildMediaType> find(?ConnectionInterface $con = null) Return ChildMediaType objects based on current ModelCriteria
 *
 * @method     ChildMediaType[]|Collection findByMediaTypeId(int|array<int> $media_type_id) Return ChildMediaType objects filtered by the media_type_id column
 * @psalm-method Collection&\Traversable<ChildMediaType> findByMediaTypeId(int|array<int> $media_type_id) Return ChildMediaType objects filtered by the media_type_id column
 * @method     ChildMediaType[]|Collection findByName(string|array<string> $name) Return ChildMediaType objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildMediaType> findByName(string|array<string> $name) Return ChildMediaType objects filtered by the name column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildMediaType> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class MediaTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Chinook\Models\Base\MediaTypeQuery object.
     *
     * @param string $dbName The database name
     * @param string $modelName The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Chinook\\Models\\MediaType', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT media_type_id, name FROM media_type WHERE media_type_id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $keys, Criteria::IN);
    ...
    public function filterByMediaTypeId($mediaTypeId = null, ?string $comparison = null)
    {
        if (is_array($mediaTypeId)) {
            ...
            if (isset($mediaTypeId['min'])) {
                $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $mediaTypeId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($mediaTypeId['max'])) {
                $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $mediaTypeId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $mediaTypeId, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(MediaTypeTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByTrack($track, ?string $comparison = null)
    {
        if ($track instanceof \Chinook\Models\Track) {
            $this
                ->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $track->getMediaTypeId(), $comparison);
    ...
    {
        if ($mediaType) {
            $this->addUsingAlias(MediaTypeTableMap::COL_MEDIA_TYPE_ID, $mediaType->getMediaTypeId(), Criteria::NOT_EQUAL);
        }
