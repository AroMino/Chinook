...
abstract class Invoice implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Chinook\\Models\\Map\\InvoiceTableMap';
    ...
    /**
     * The value for the billing_address field.
     *
     * @var        string|null
     */
    ...
    /**
     * Initializes internal state of Chinook\Models\Base\Invoice object.
     */
    ...
    /**
     * Get the [billing_address] column value.
     *
     * @return string|null
     */
    ...
    public function setInvoiceId($v)
    {
        ...
        if ($this->invoice_id !== $v) {
            $this->invoice_id = $v;
            $this->modifiedColumns[InvoiceTableMap::COL_INVOICE_ID] = true;
        }
    ...
    public function setCustomerId($v)
    {
        ...
        if ($this->customer_id !== $v) {
            $this->customer_id = $v;
            $this->modifiedColumns[InvoiceTableMap::COL_CUSTOMER_ID] = true;
        }
    ...
    /**
     * Set the value of [billing_address] column.
     *
     * @param string|null $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setBillingAddress($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->billing_address !== $v) {
            $this->billing_address = $v;
            $this->modifiedColumns[InvoiceTableMap::COL_BILLING_ADDRESS] = true;
        }
    ...
    public function setBillingCity($v)
    {
        ...
        if ($this->billing_city !== $v) {
            $this->billing_city = $v;
            $this->modifiedColumns[InvoiceTableMap::COL_BILLING_CITY] = true;
        }
    ...
    public function setBillingState($v)
    {
        ...
        if ($this->billing_state !== $v) {
            ...
            $this->modifiedColumns[InvoiceTableMap::COL_BILLING_STATE] = true;
        }
    ...
    public function setBillingCountry($v)
    {
        ...
        if ($this->billing_country !== $v) {
            ...
            $this->modifiedColumns[InvoiceTableMap::COL_BILLING_COUNTRY] = true;
        }
    ...
    public function setBillingPostalCode($v)
    {
        ...
        if ($this->billing_postal_code !== $v) {
            ...
            $this->modifiedColumns[InvoiceTableMap::COL_BILLING_POSTAL_CODE] = true;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[InvoiceTableMap::COL_TOTAL] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvoiceTableMap::translateFieldName('CustomerId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvoiceTableMap::translateFieldName('BillingAddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_address = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvoiceTableMap::translateFieldName('BillingCity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvoiceTableMap::translateFieldName('BillingState', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvoiceTableMap::translateFieldName('BillingCountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InvoiceTableMap::translateFieldName('BillingPostalCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billing_postal_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : InvoiceTableMap::translateFieldName('Total', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = InvoiceTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Chinook\\Models\\Invoice'), 0, $e);
        }
    }
    ...
    {
        if ($this->aCustomer !== null && $this->customer_id !== $this->aCustomer->getCustomerId()) {
            $this->aCustomer = null;
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $this->modifiedColumns[InvoiceTableMap::COL_INVOICE_ID] = true;
        if (null !== $this->invoice_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . InvoiceTableMap::COL_INVOICE_ID . ')');
        }
        if (null === $this->invoice_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('invoice_invoice_id_seq')");
                $this->invoice_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(InvoiceTableMap::COL_INVOICE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_id';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_CUSTOMER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'customer_id';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_INVOICE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_date';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'billing_address';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'billing_city';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'billing_state';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'billing_country';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_POSTAL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'billing_postal_code';
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_TOTAL)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'billing_address':
                        $stmt->bindValue($identifier, $this->billing_address, PDO::PARAM_STR);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = [], bool $includeForeignObjects = false): array
    {
        ...
        $result = [
            ...
            $keys[3] => $this->getBillingAddress(),
            $keys[4] => $this->getBillingCity(),
            $keys[5] => $this->getBillingState(),
            $keys[6] => $this->getBillingCountry(),
            $keys[7] => $this->getBillingPostalCode(),
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setBillingAddress($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setBillingCity($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setBillingState($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setBillingCountry($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setBillingPostalCode($arr[$keys[7]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(InvoiceTableMap::COL_INVOICE_ID)) {
            $criteria->add(InvoiceTableMap::COL_INVOICE_ID, $this->invoice_id);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_CUSTOMER_ID)) {
            $criteria->add(InvoiceTableMap::COL_CUSTOMER_ID, $this->customer_id);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_INVOICE_DATE)) {
            $criteria->add(InvoiceTableMap::COL_INVOICE_DATE, $this->invoice_date);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_ADDRESS)) {
            $criteria->add(InvoiceTableMap::COL_BILLING_ADDRESS, $this->billing_address);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_CITY)) {
            $criteria->add(InvoiceTableMap::COL_BILLING_CITY, $this->billing_city);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_STATE)) {
            $criteria->add(InvoiceTableMap::COL_BILLING_STATE, $this->billing_state);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_COUNTRY)) {
            $criteria->add(InvoiceTableMap::COL_BILLING_COUNTRY, $this->billing_country);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_BILLING_POSTAL_CODE)) {
            $criteria->add(InvoiceTableMap::COL_BILLING_POSTAL_CODE, $this->billing_postal_code);
        }
        if ($this->isColumnModified(InvoiceTableMap::COL_TOTAL)) {
            $criteria->add(InvoiceTableMap::COL_TOTAL, $this->total);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \Chinook\Models\Invoice (or compatible) type.
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setBillingAddress($this->getBillingAddress());
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Chinook\Models\Invoice Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    public function setInvoiceLines(Collection $invoiceLines, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($invoiceLinesToDelete as $invoiceLineRemoved) {
            $invoiceLineRemoved->setInvoice(null);
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildInvoiceLine}> List of ChildInvoiceLine objects
     */
    public function getInvoiceLinesJoinTrack(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildInvoiceLineQuery::create(null, $criteria);
        $query->joinWith('Track', $joinBehavior);
