...
abstract class Artist implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Chinook\\Models\\Map\\ArtistTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildAlbum> Collection to store aggregation of ChildAlbum objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildAlbum>
     */
    protected $albumsScheduledForDeletion = null;

    /**
     * Initializes internal state of Chinook\Models\Base\Artist object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            return $startcol + 2; // 2 = ArtistTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Chinook\\Models\\Artist'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->albumsScheduledForDeletion !== null) {
                if (!$this->albumsScheduledForDeletion->isEmpty()) {
                    \Chinook\Models\AlbumQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if (null === $this->artist_id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('artist_artist_id_seq')");
                $this->artist_id = (int) $dataFetcher->fetchColumn();
            } catch (Exception $e) {
     ...
     * objects.
     *
     * @param object $copyObj An object of \Chinook\Models\Artist (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Chinook\Models\Artist Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialAlbums($v = true): void
    {
     ...
     * @return void
     */
    public function initAlbums(bool $overrideExisting = true): void
    {
        ...
        $this->collAlbums->setModel('\Chinook\Models\Album');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildAlbum> List of ChildAlbum objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collAlbums || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collAlbums) {
                    ...
                    $collAlbums = new $collectionClassName;
                    $collAlbums->setModel('\Chinook\Models\Album');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countAlbums(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collAlbumsPartial && !$this->isNew();
        if (null === $this->collAlbums || null !== $criteria || $partial) {
     ...
     */
    protected function doAddAlbum(ChildAlbum $album): void
    {
