...
class PlaylistTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'Chinook.Models.Map.PlaylistTableMap';
     ...
     */
    public const TABLE_NAME = 'playlist';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'Playlist';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Chinook\\Models\\Playlist';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Chinook.Models.Playlist';
     ...
     */
    public const COL_PLAYLIST_ID = 'playlist.playlist_id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'playlist.name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['PlaylistId', 'Name', ],
        self::TYPE_CAMELNAME     => ['playlistId', 'name', ],
        self::TYPE_COLNAME       => [PlaylistTableMap::COL_PLAYLIST_ID, PlaylistTableMap::COL_NAME, ],
        self::TYPE_FIELDNAME     => ['playlist_id', 'name', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['PlaylistId' => 0, 'Name' => 1, ],
        self::TYPE_CAMELNAME     => ['playlistId' => 0, 'name' => 1, ],
        self::TYPE_COLNAME       => [PlaylistTableMap::COL_PLAYLIST_ID => 0, PlaylistTableMap::COL_NAME => 1, ],
        self::TYPE_FIELDNAME     => ['playlist_id' => 0, 'name' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'playlistId' => 'PLAYLIST_ID',
        'playlist.playlistId' => 'PLAYLIST_ID',
        'PlaylistTableMap::COL_PLAYLIST_ID' => 'PLAYLIST_ID',
        ...
        'name' => 'NAME',
        'playlist.name' => 'NAME',
        'PlaylistTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\Chinook\\Models\\Playlist');
        $this->setPackage('Chinook.Models');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('playlist_playlist_id_seq');
        // columns
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PlaylistTableMap::COL_PLAYLIST_ID);
            $criteria->addSelectColumn(PlaylistTableMap::COL_NAME);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(PlaylistTableMap::COL_PLAYLIST_ID);
            $criteria->removeSelectColumn(PlaylistTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Chinook\Models\Playlist) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(PlaylistTableMap::DATABASE_NAME);
            $criteria->add(PlaylistTableMap::COL_PLAYLIST_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ?ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(PlaylistTableMap::COL_PLAYLIST_ID) && $criteria->keyContainsValue(PlaylistTableMap::COL_PLAYLIST_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.PlaylistTableMap::COL_PLAYLIST_ID.')');
        }
